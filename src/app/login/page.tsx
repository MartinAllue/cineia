          ...
          <div className="mt-6 pt-6 border-t border-[#333]">
            <div className="relative">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-2 bg-[#1a1a1a] text-gray-500">O continúa con</span>
              </div>
            </div>

            <button
              onClick={() => signIn('google', { callbackUrl: '/' })}
              className="mt-4 w-full bg-white text-gray-800 hover:bg-gray-100 py-3 rounded-lg font-medium transition-colors flex items-center justify-center gap-2"
            >
